...
```bash
g++ -o rpcelp rpcelp.cpp
tetrapol_dump -r 42000 -t TCH 2>/dev/null | grep '"type": "VOICE"' | grep -oE '"value": "[0-9a-f]{30}"' | cut -d \" -f 4 | ./blhexbit.py | sed -re "s/(.)(.)(.)(.) (.)(.)(.)(.) /\8\7\6\5\4\3\2\1/g" | sed -re "s/^([01]{20})/\1/g" | ./rpcelp | fplay -hide_banner -af "speechnorm=e=40:r=0.0001:l=1,acompressor=ratio=10:makeup=14,bandpass=width_type=h:width=5500" -f s16le -ar 8000 -i pipe:0
```
